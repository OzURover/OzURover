...
######################################################
    ...
    #####################################################
        ...
        rospy.Subscriber("RM_EncoderTicks", Int32, self.wheelCallback)
        rospy.Subscriber("rm_wheel_velocity_target", Float32, self.targetCallback)
        self.pub_motor = rospy.Publisher('rm_motor_cmd', PointStamped, queue_size=10)
