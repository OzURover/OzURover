...
######################################################
    ...
    #####################################################
        ...
        rospy.Subscriber("LB_EncoderTicks", Int32, self.wheelCallback)
        rospy.Subscriber("lb_wheel_velocity_target", Float32, self.targetCallback)
        self.pub_motor = rospy.Publisher('lb_motor_cmd', PointStamped, queue_size=10)
