...
######################################################
    ...
    #####################################################
        ...
        rospy.Subscriber("RB_EncoderTicks", Int32, self.wheelCallback)
        rospy.Subscriber("rb_wheel_velocity_target", Float32, self.targetCallback)
        self.pub_motor = rospy.Publisher('rb_motor_cmd', PointStamped, queue_size=10)
