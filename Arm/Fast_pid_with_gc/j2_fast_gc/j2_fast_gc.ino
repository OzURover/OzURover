...
PID armPID (&angle1, &PID_PWM, &GoalPosition,3500,100,20, DIRECT); //angle1 is encoder reading
...
void messageCb2(const std_msgs::Float32& curr_pos_j1){
  angle2 = curr_pos_j1.data;
}
...
ros::Subscriber<std_msgs::Float32> sub2("curr_pos_j1", &messageCb2 );
...
*/
  ...
  gravityTork = 1/2*m2*g*l2*cos(angle1*57.2958-angle2*57.2958)/1000;
